# evaluation/preference/image_reward.py
...
"""
ImageReward is typically provided via community packages / HF repos.
This wrapper supports:
- "custom" backend: you provide your own callable (prompt, image) -> score
- fallback proxy: CLIP text-image similarity (NOT real ImageReward)

If you tell me which ImageReward package/repo you're using, I’ll wire the exact code.
"""
...
class ImageRewardScore:
    def __init__(self, cfg: ImageRewardConfig = ImageRewardConfig()):
        self.cfg = cfg
